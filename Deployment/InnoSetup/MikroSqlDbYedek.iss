; MikroSqlDbYedek — Inno Setup Script
...
;   3. Veya: ISCC.exe MikroSqlDbYedek.iss
;
; Gereksinim: Inno Setup 6.2+

; === TANIMLAMALAR ===
#define MyAppName "MikroSqlDbYedek"
#define MyAppVersion "0.14.0"
#define MyAppPublisher "HZK"
#define MyAppURL "https://github.com/hzkucuk/MikroSqlDbYedek"
#define MyAppExeName "MikroSqlDbYedek.Win.exe"
#define MyServiceExeName "MikroSqlDbYedek.Service.exe"
#define MyServiceName "MikroSqlDbYedekService"
...
; Çıktı
OutputDir=..\..\releases
OutputBaseFilename=MikroSqlDbYedek_v{#MyAppVersion}_Setup
; Sıkıştırma
