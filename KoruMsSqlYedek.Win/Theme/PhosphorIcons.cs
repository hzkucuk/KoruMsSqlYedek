    ...
    internal static class PhosphorIcons
    {
        ...
        private static void EnsureInitialized()
        {
            ...
            lock (_lock)
            {
                ...
                _fillFamily = LoadEmbeddedFont("KoruMsSqlYedek.Win.Resources.Fonts.Phosphor-Fill.ttf");
                _boldFamily = LoadEmbeddedFont("KoruMsSqlYedek.Win.Resources.Fonts.Phosphor-Bold.ttf");
                _initialized = true;
            }
        }
